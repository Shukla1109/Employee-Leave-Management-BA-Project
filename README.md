# Employee Leave & Attendance Management System – Business Analysis Case Study

Project Type
Business Analysis Case Study (Non-Technical / No Coding)
...
Provide real-time leave balance visibility
...
03_BPMN_AsIs.pdf	AS-IS manual leave process

04_BPMN_ToBe.pdf	TO-BE automated workflow

05_MoSCoW.pdf	Prioritization of requirements using MoSCoW framework
...
Manager replies when available

HR updates Excel manually
...
Employee applies leave through portal

System validates & routes approval

Manager approves/rejects digitally

Leave balance & attendance sync automatically
